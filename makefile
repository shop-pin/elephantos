...
$(BUILD_DIR)/memory.o: kernel/memory.c kernel/memory.h lib/stdint.h \
	lib/kernel/bitmap.h kernel/global.h kernel/global.h \
       	kernel/debug.h lib/kernel/print.h lib/kernel/io.h \
...
$(BUILD_DIR)/sync.o: thread/sync.c thread/sync.h lib/kernel/list.h \
	...
	lib/stdint.h kernel/debug.h kernel/interrupt.h
	$(CC) $(Mc) $(CFLAGS) $< -o $@
...
hd:
	dd if=$(BUILD_DIR)/kernel.bin \
           of=/home/l/elephantos/hd60M.img \
